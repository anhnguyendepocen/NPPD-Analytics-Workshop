...
## Your Turn {.yourturn  data-background=#8EC8D7}
...
## Solutions {.solutions  data-background=#8EC8D7}
1. Read the first two lines of the file into an object called `midwest_names`
```{r}
...
midwest2 <- read_excel("./data/midwest.xlsx")
names(midwest2) <- make.names(names(midwest2))
head(midwest2, 4)
```
...
## Solution {.solutions data-background=#8EC8D7}
...
## Solutions {.yourturn data-background=#8EC8D7}
1. Use `tidyr` to convert this data into a long format.
```{r}
