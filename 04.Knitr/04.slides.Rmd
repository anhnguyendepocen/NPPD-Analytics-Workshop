...
- It's **simple**. Focus on writing, rather than debugging silly errors or where pictures should go
...
- Markdown is becoming a standard. Many websites will generate HTML from Markdown.
...
* R package vignettes
* [Many](http://lincolnmullen.com/projects/dh-r/index.html) great [tutorials](http://renkun.me/learnR/) use R markdown with add-ons such as [Rgitbook](http://jason.bryer.org/Rgitbook/).
...
- Stuff you'd find in formal publications:
    * Figure/table referencin
        - This is actually available in markdown for Word with some extra code, and works with pdfs
- Many, many appearance related things (image/figure alignment, coloring, font families, etc.) 


## There is hope...

- Markdown will work with HTML/`LaTeX` markup, but don't expect it to convert between output formats.
